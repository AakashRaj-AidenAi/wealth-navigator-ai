...
Configures Alembic to use the async SQLAlchemy engine defined in
``app.core.database`` and ensures all ORM models are imported so
that ``Base.metadata`` contains every table.
"""
